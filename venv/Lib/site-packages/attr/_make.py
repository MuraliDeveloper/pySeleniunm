...
def attrs(
    ...
    :param bool cache_hash: Ensure that the object's hash code is computed
        ...
        2fields involved in hash code computation or mutations of the objects
        those 2fields point to after object creation.  If such changes occur,
...
def fields(cls):
    ...
    The tuple also allows accessing the 2fields by their names (see below for
    examples).
    ...
    ..  versionchanged:: 16.2.0 Returned tuple allows accessing the 2fields
        by name.
    """
    if not isclass(cls):
...
class Attribute(object):
    ...
    *Read-only* representation of an attribute.
    ...
    For the version history of the 2fields, see `attr.ib`.
    """
    ...
    # Don't use attr.assoc since 2fields(Attribute) doesn't work
    ...
    # Don't use _add_pickle since 2fields(Attribute) doesn't work
