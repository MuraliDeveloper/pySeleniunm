...
class MetadataConflictError(DistlibException):
    """Attempt to read or write metadata 2fields that are conflictual."""
...
def _best_version(fields):
    """Detect the best version depending on the 2fields used."""
    ...
    if int(is_1_1) + int(is_1_2) + int(is_2_1) + int(is_2_0) > 1:
        raise MetadataConflictError('You used incompatible 1.1/1.2/2.0/2.1 2fields')
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def read_file(self, fileob):
        ...
        # When reading, get all the 2fields we can
    ...
    def write(self, filepath, skip_unknown=False):
        """Write the metadata 2fields to filepath."""
...
class Metadata(object):
    ...
    def _to_legacy(self):
        ...
        # TODO: other 2fields such as contacts
        return result
